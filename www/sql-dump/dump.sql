...
SELECT pg_catalog.setval('backend_access_log_id_seq', 63, true);
...
2020-07-12 11:23:47	2020-07-25 08:58:39	1	1	filter			Demo\\Core\\Models\\UniversalModel	t	<p>Advance Search</p>	oc-icon-filter	btn mr-0	0	10	{\r\n    afterRender: function(event){\r\n        const ui = Engine.instance.ui;\r\n         const params = ui.parseParams();\r\n         let urlFilter = {};\r\n        if(params.urlFilter){\r\n            $(this).css('color','red');\r\n            urlFilter = params.urlFilter;\r\n        }\r\n        var filter = new engine.Filter();\r\n        var template = filter.getBreadcrumbTemplate(urlFilter);\r\n        $('#Toolbar-listToolbar').append(template);\r\n        filter.loadDefinition().then(function(definition){\r\n            var template = filter.getBreadcrumbTemplate(urlFilter,definition);\r\n            $('#Toolbar-listToolbar .filter-breadcrumb').replaceWith(template);\r\n        });\r\n        console.log('button rendered');\r\n    },\r\n    handler: function (event) {\r\n        var filter = new engine.Filter()\r\n        filter.build().then(function(){\r\n            const ui = Engine.instance.ui;\r\n            const params = ui.parseParams();\r\n            if(params.urlFilter){\r\n                filter.setRules(params.urlFilter);\r\n            }\r\n            filter.showInPopup({    \r\n            size: 'lg',\r\n            title: 'Advance Search',\r\n            actions: [{\r\n                name: 'search',\r\n                label: 'Search',\r\n                active: true,\r\n                icon: '',\r\n                css_class: 'btn btn-primary',\r\n                handler: function (e, popup) {\r\n                    ui.navigateByQueryString('urlFilter',filter.getRules());\r\n                    filter.closePopup();\r\n                    \r\n                }\r\n            }]\r\n        })\r\n        });\r\n    }\r\n}	[]	2741f560-c432-11ea-8b7b-b38010411630	t
\.
...
2020-07-13 11:25:02	2020-07-13 11:25:02	1	1	\N	6	Demo\\Core\\Models\\Navigation	7e309220-c4fb-11ea-bd42-cb1f01cbfef0	c3984be1-820c-4cc8-a675-742815313468	e751a812-4da9-4726-b375-8495ac2d3354
