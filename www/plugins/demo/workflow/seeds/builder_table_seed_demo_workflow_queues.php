    ...
    public function install()
    {
        Db::table('demo_workflow_queues')->insert([
            [
                ...
                "input_condition"=> "return \$context->item->model === 'Demo\\Casemanager\\Models\\CaseModel';",
                "active"=> 1,
