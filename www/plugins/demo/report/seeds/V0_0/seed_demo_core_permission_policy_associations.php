<?php
namespace Demo\Report\Seeds\V0_0;
...
class SeedDemoCorePermissionPolicyAssociations implements Seedable
{
    ...
    {
                    Db::table('demo_core_permission_policy_associations')->where('engine_application_id', 'cf0c66c7-12c9-43df-813c-14aeafdf6ae1')->delete();
            }
}
