...
class SeedDemoCoreModels implements Seedable
{
    ...
    public function install()
    {
            ...
            [
                                                                            ...
                                                                            "id"=>"c34da140-e9c6-11ea-84b8-9347751e17dc",
                                                                                        "created_at"=>"2020-08-29 07:10:48",
                                                                                        "updated_at"=>"2020-08-29 07:33:25",
                                                                                        "created_by_id"=> 1,
                                                                                        "updated_by_id"=> 1,
                                                                                        "name"=>"Application",
                                                                                        "model"=>"Demo\Core\Models\EngineApplication",
                                                                                        "controller"=>"Demo\Core\Controllers\ApplicationController",
                                                                                        "engine_application_id"=>"dc81b635-1d0a-4f3e-83af-13642d56abe4",
                                                                                        "audit"=> false,
                                                                                        "viewable"=> false,
                                                                                        "record_history"=> false,
                                                                            ...
                                                                            "id"=>"8eb30d4a-48bd-4ca7-b848-d9245be0d63d",
                                                                                        "created_at"=>"2019-12-20 14:15:39",
                                                                                        "updated_at"=>"2020-10-07 05:06:38",
                                                                                        "created_by_id"=> 1,
                                                                                        "updated_by_id"=> 1,
                                                                                        "name"=>"User Group",
    ...
    {
                    Db::table('demo_core_models')->where('engine_application_id', 'dc81b635-1d0a-4f3e-83af-13642d56abe4')->delete();
            }
}
