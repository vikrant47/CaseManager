...
class SeedDemoCoreListActions implements Seedable
{
    ...
    {
                    Db::table('demo_core_list_actions')->where('engine_application_id', 'dc81b635-1d0a-4f3e-83af-13642d56abe4')->delete();
            }
}
