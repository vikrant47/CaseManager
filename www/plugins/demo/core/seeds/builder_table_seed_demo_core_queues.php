...
class BuilderTableSeedDemoCoreQueues extends Seeder
{
    public function run()
    {
        Db::table('demo_core_queues')->insert([
            [
                "id" => 21,
                ...
                "supported_item_type" => "Demo\Casemanager\Models\CaseModel",
