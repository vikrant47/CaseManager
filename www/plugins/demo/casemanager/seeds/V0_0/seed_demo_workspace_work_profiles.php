...
class SeedDemoWorkspaceWorkProfiles implements Seedable
{
    /**This will be executed to install seeds*/
    public function install()
    {
            Db::table('demo_workspace_work_profiles')->insert([
            [
    ...
    {
                    Db::table('demo_workspace_work_profiles')->where('engine_application_id', 'df07f9b4-26c1-40ca-ba1f-1b77b1692b83')->delete();
            }
}
