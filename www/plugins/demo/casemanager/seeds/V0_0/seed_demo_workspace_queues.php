...
class SeedDemoWorkspaceQueues implements Seedable
{
    /**This will be executed to install seeds*/
    public function install()
    {
            Db::table('demo_workspace_queues')->insert([
            [
                                                                            "id"=>"85cd4fd8-16a9-482a-b47f-ff7bae2b79d3",
                                                                                        ...
                                                                                        "priority"=> -900,
                                                                                        "age_priority"=> 1,
                                                                                        "age_unit"=>"milliseconds",
                                                                                        "age_priority_boost"=> 1.00,
                                                                            ...
                                                                            "id"=>"c83b37aa-0fd9-4987-bff7-1a604da1ffde",
                                                                                        ...
                                                                                        "priority"=> 10,
                                                                                        "age_priority"=> 1,
                                                                                        "age_unit"=>"millisecond",
                                                                                        "age_priority_boost"=> -7.00,
                                                                                        "created_at"=>"2019-10-13 03:46:56",
                                                                                        "updated_at"=>"2020-10-08 15:43:01",
                                                                                        "created_by_id"=> 1,
                                                                                        "updated_by_id"=> 1,
                                                                                        "engine_application_id"=>"df07f9b4-26c1-40ca-ba1f-1b77b1692b83",
                                                                                        "routing_rule_id"=>"0e0ccad0-13fe-447e-a476-966159910a54"
    ...
    {
                    Db::table('demo_workspace_queues')->where('engine_application_id', 'df07f9b4-26c1-40ca-ba1f-1b77b1692b83')->delete();
            }
}
